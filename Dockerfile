...
ADD https://ci.opencollab.dev/job/GeyserMC/job/Geyser/job/master/$BUILD_TYPE/artifact/bootstrap/standalone/build/libs/Geyser-Standalone.jar /opt/Geyser.jar
